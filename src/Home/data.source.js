...
export const Nav30DataSource = {
  ...
  page: { className: 'home-page kgqmxmypd87-editor_css' },
  logo: {
    className: 'header3-logo kgqmzowfpqg-editor_css',
    children:
          ...
          children: [
            {
              ...
              name: 'text',
              className: 'kgqmwzk6mri-editor_css',
            },
          ],
        },
        subItem: [
          ...
          children: [
            {
              ...
              name: 'text',
              className: 'kgqmxnj5j9-editor_css',
            },
          ],
        },
      },
    ...
    children: [
      {
        ...
        page: { className: 'home-page banner2-page kgqlsix4j5g-editor_css' },
        textWrapper: {
          className: 'banner2-text-wrapper kgqn2i8cgo8-editor_css',
        },
        bg: { className: 'bg bg0' },
        title: { className: 'banner2-title', children: 'ATRIS' },
        content: {
          className: 'banner2-content',
          children: (
            <span>
              <span>
                <p>Intelligent Safty Parol Robot</p>
              </span>
            </span>
          ),
        },
        button: {
          className: 'banner2-button kgqlu4ycx2c-editor_css',
          children: 'Learn More',
        },
      },
    ],
...
export const Content50DataSource = {
  wrapper: {
    className: 'home-page-wrapper content5-wrapper kgqni12s2ma-editor_css',
  },
  page: { className: 'home-page content5 kgqn7tp3wah-editor_css' },
  OverPack: { playScale: 0.3, className: '' },
  titleWrapper: {
    className: 'title-wrapper kgqnfk26njn-editor_css',
    children: [
      {
        name: 'title',
        children: (
          <span>
            <span>
              <span>
                <p>Hello，there！ I’m Sherrin Meng</p>
              </span>
            </span>
          </span>
        ),
        className: 'title-h1 kgqn7q6thdj-editor_css',
      },
      {
        name: 'content',
        className: 'title-content kgqnex7w9c-editor_css',
        children: (
          <span>
            <p>
              I’m a UX designer with 10 working experiences ，now I’m focus on
              the Intelligent Safty Patrol Robot and Public Service Robot
  ...
  block: {
    className: 'content5-img-wrapper kgqnmmr3y7g-editor_css',
    gutter: 16,
    children: [
      {
        name: 'block0',
        className: 'block kgqnx60l7d-editor_css',
        md: 6,
        xs: 24,
        children: {
